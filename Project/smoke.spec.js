...
describe("Smoke test", function() {
	var designBetaPage = require("./design.beta.page.js");
	var pricingAndProducts = require("./pricingAndProducts.js");
	var loginPage = require("./login.page.js");
	var launchPage = require("./launch.page.js");
	var productCategory;
	var product;
	var random;
	...
	it("Add Additional products", function() {
		...
		if (random) {
			pricingAndProducts.clickAddAdditionalProductsPage();
			browser.sleep(4000);
